  ...
  return (
    <div className="auth-container">
      <div className="card auth-card">
        ...
        <p className="auth-subtitle">Sign in to manage your links and view real-time click statistics</p>
        ...
        <button onClick={handleGitHubLogin} className="btn btn-github" style={{ width: '100%' }}>
